...
%build
%configure --with-all=no --disable-glite --with-interfaces=yes \
    --enable-java=no --with-cpp-api=yes --libexecdir=%{_datadir} \
    --sysconfdir=%{_datadir}
...
- Split into separate spec files.  This is the devel specfile
