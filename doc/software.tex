...
%\textbf{--confile}    & Specifies a non-standard location of the
%		      system-wide vomses files.  The default value for
%		      this option is ``/opt/edg/atc/vomses''.\\
%\textbf{--userconf}   & Specifies a non-standard location of the
%		      user-specific config files.  The default value
%		      for this option is ``\$HOME/.edg/vomses''.\\
