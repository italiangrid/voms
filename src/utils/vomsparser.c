...
{
      11,     0,    -1,    12,    -1,    11,    12,    -1,     5,     4,
       6,    13,    -1,     5,     4,     6,    -1,    14,    -1,    13,
      14,    -1,     4,     7,    15,    -1,     4,     7,    15,     7,
      15,    -1,     4,     7,    15,     7,    15,     8,    15,     9,
      -1,     4,    -1,     3,    -1
};
...
{
  "$end", "error", "$undefined", "STRING", "ID", "'['", "']'", "'='",
  "'('", "')'", "$accept", "text", "vo", "voparams", "voparam", "value", 0
};
#endif
...
#line 36 "vomsfake.y"
  ...
  (yyval.vos)->current=0;
  (yyval.vos)->vos[(yyval.vos)->current++] = (yyvsp[(1) - (1)].vo);
  volist = (yyval.vos);
 }
    break;
...
#line 82 "vomsfake.y"
  ...
  (yyval.params)->params[(yyval.params)->current++] = (yyvsp[(1) - (1)].param);
 }
    break;
...
#line 94 "vomsfake.y"
  ...
  (yyval.param)->value = (yyvsp[(3) - (3)].input);
 }
    break;
