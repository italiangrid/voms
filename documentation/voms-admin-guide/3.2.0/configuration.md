---
layout: default
title: VOMS Admin configuration
---
...
| `voms.mebership.default_lifetime` | Default VO membership lifetime duration (in months). This setting is used to compute the default membership expiration date for newly created users | 12 |
